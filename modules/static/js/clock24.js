...
var mediumArrowLenght = 50;
var slowArrowLenght = 30;
...
(function(){
    ...
    function draw_24_clock_labels(){
      ...
      for(i=1;i<=fullrange;i++){
        posx = clockx + Math.sin(-i/fullrange*2*Math.PI+Math.PI)*(clockrad-bd-13-15)
        posy = clocky + Math.cos(i/fullrange*2*Math.PI+Math.PI)*(clockrad-bd-13-15)+8
        if ((i%spacing) == 0){
